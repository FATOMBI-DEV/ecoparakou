  ...
  $secteurs_menu = $mysqli->query("SELECT nom, slug FROM secteurs ORDER BY nom ASC");
  ?>
  ...
  <header class="navbar navbar-expand-lg bg-dark text-light fixed-top shadow-sm py-2">
    <div class="container-fluid">
      ...
      <a href="/ecoparakou/public/index.php" class="navbar-brand d-flex align-items-center text-light gap-2">
        <img src="/ecoparakou/public/assets/img/logoep.png" alt="Logo" height="42">
        <span><?= SITE_NAME ?></span>
      </a>
      ...
      <div class="collapse navbar-collapse" id="mainNav">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-center gap-lg-3">
          ...
          <li class="nav-item">
            <a class="nav-link text-light" href="/ecoparakou/public/inscrit_entreprise.php">Inscrire</a>
          </li>
    ...
    <div id="loader-overlay">
      <div class="loader-stack">
        <img src="/ecoparakou/public/assets/img/logoep.png" alt="Eco Parakou" class="loader-logo">
  ...
  window.addEventListener("load", () => {
    ...
    if (loader) {
      loader.classList.add("hidden"); // Utilise la classe CSS pour transition douce
      setTimeout(() => loader.remove(), 500); // Supprime après transition
    }
  });

  // Afficher le loader sur clic de lien ou soumission de formulaire
