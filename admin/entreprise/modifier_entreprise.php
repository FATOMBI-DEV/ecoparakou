    <?php
        ...
        $id = intval($_GET['id'] ?? 0);
        if (!$id) {
        header("Location: liste_entreprise.php?error=id_invalide");
        exit;
        }
        ...
        $sujet = "Modification de votre fiche entreprise sur ";
        $contenu = "
    ...
    <html lang="fr">
        <head>
            ...
            <link rel="stylesheet" href="../../public/assets/css/modifier_entreprise.css">
