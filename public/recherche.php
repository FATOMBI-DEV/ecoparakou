      ...
      <main>
        <div class="container">
         <h2 class="section-title">
            <i class="bi bi-search me-2 text-accent"></i> Résultats pour : <strong><?= htmlspecialchars($q) ?></strong>
          </h2>
...
while ($e = $result->fetch_assoc()) {
  ...
  ?>
  <a href="/ecoparakou/public/entreprise.php?slug=<?= $e['slug'] ?>" 
     class="entreprise-card" 
